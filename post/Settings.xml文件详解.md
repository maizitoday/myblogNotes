...
**转载地址：https://www.cnblogs.com/dalianpai/p/11850539.html**
...
user.home/.m2/settings.xml：用户配置优先于全局配置。{user.home} 和和所有其他系统属性只能在3.0+版本上使用。请注意windows和Linux使用变量的区别。
...
```xml
<localRepository>/java/mavenLibs</localRepository>
```
